  ...
  return (
    <>
      <SEO
        ...
        description="Prime Crackers delivers across India. Learn how ordering and delivery works."
        url="/delivery"
      />
      ...
      <FestivePageBackground>
        ...
        <div className="mx-auto max-w-3xl space-y-6 px-4 py-10 sm:px-6">
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-2xl border border-[#004D55]/10 bg-white p-5 shadow-sm">
              <Truck className="h-8 w-8 text-[#004D55]" />
              <p className="mt-3 text-[10px] font-bold uppercase tracking-wider text-[#004D55]/55">
                Coverage
              </p>
              <p className="mt-1 font-display text-xl font-extrabold text-[#004D55]">
                {policies.delivery_areas}
              </p>
            </div>
            <div className="rounded-2xl border border-[#004D55]/10 bg-white p-5 shadow-sm">
              <MapPin className="h-8 w-8 text-[#E65100]" />
              <p className="mt-3 text-[10px] font-bold uppercase tracking-wider text-[#004D55]/55">
                Based in
              </p>
              <p className="mt-1 text-sm font-semibold text-[#004D55]">Sivakasi, Tamil Nadu</p>
            </div>
          </div>

          <div className="rounded-2xl border border-[#004D55]/10 bg-white p-6 shadow-sm">
            <h2 className="font-display text-lg font-extrabold uppercase text-[#004D55]">
              How delivery works
            </h2>
            <ol className="mt-4 space-y-3">
              {STEPS.map((step, i) => (
                <li key={step} className="flex gap-3 text-sm text-[#004D55]/85">
                  <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#FFC107] text-xs font-bold text-[#004D55]">
                    {i + 1}
                  </span>
                  {step}
                </li>
          ...
          {whatsapp && (
            <a
              href={buildWhatsAppContactUrl(whatsapp, 'Hi Prime Crackers, I need delivery information for my location.')}
              target="_blank"
          ...
          <p className="text-center text-xs text-[#004D55]/55">
            <Link to="/account/help" className="font-semibold text-[#004D55] hover:text-[#FFC107]">
