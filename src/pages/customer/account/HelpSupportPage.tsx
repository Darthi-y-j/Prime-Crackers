...
export function HelpSupportPage() {
  ...
  const whatsappUrl = whatsappNumbers[0]
    ? buildWhatsAppUrl(whatsappNumbers[0], 'Hi Prime Crackers, I need help with my enquiry.')
    : '/contact'
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-4xl space-y-6 px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div>
          <p className="mb-3 flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.16em] text-[#004D55]/55">
          ...
          <div className="grid gap-3 sm:grid-cols-3">
            <QuickActionCard
              ...
              accent="#006670"
              icon={<HelpCircle className="h-5 w-5 text-[#006670]" />}
            />
            <QuickActionCard
              to="/contact"
              label="Contact"
              ...
              accent="#004D55"
              icon={<Phone className="h-5 w-5 text-[#004D55]" />}
            />
            <QuickActionCard
              to="/delivery"
              label="Delivery"
              ...
              accent="#E65100"
              icon={<Truck className="h-5 w-5 text-[#E65100]" />}
            />
          </div>
        </div>
        ...
        <MenuSection title="Policies & information">
          <MenuLink
            to="/delivery"
            icon={<Truck className="h-5 w-5 text-[#004D55]" />}
            label="Delivery Information"
            description="How ordering & delivery works"
          />
          <MenuLink
            to="/terms"
            icon={<FileText className="h-5 w-5 text-[#004D55]" />}
            label="Terms & Conditions"
            description="Ordering and website terms"
          />
          <MenuLink
            to="/safety"
            icon={<Shield className="h-5 w-5 text-[#E65100]" />}
        ...
        <Link
          to="/"
          className="flex items-center justify-center gap-2 rounded-2xl border border-[#004D55]/15 bg-white py-3.5 text-sm font-bold text-[#004D55] shadow-sm transition hover:border-[#FFC107]/50 hover:bg-[#FFF8E1]/50"
        >
          Continue shopping
