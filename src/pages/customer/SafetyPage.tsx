  ...
  return (
    <>
      <SEO
        ...
        description="Fireworks dos and don'ts — celebrate safely with Prime Crackers' responsible usage guide."
        url="/safety"
      />
            ...
            <AnimateIn animation="fade-up">
              <div className="mt-6 max-w-2xl">
                ...
                <h1 className="mt-4 font-display text-3xl font-extrabold uppercase tracking-wide text-white sm:text-4xl lg:text-5xl">
                  Fireworks <span className="text-[#FFC107]">Dos & Don'ts</span>
                </h1>

                <p className="mt-4 text-sm leading-relaxed text-white/85 sm:text-base">
                  Celebrate responsibly with these essential guidelines for a safe and joyful experience with Prime Crackers.
                </p>
