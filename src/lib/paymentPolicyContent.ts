...
export const paymentPolicyPageSections = [
  {
    ...
    paragraphs: [
      'Prime Crackers operates as a catalogue and enquiry platform. Fireworks sales involve location-specific rules, transport restrictions, and licensing checks that must be verified before an order is accepted.',
